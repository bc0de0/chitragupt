...
-- NOTE: embedding dimension is locked to 3072 (google/gemini-embedding-001) for this
-- vector namespace. Changing it requires a full re-embed migration (see DATABASE.md §1.11).
